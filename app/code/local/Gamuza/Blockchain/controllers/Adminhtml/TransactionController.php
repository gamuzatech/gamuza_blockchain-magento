...
class Gamuza_Blockchain_Adminhtml_TransactionController extends Mage_Adminhtml_Controller_Action
{
	...
	{
	    return Mage::getSingleton ('admin/session')->isAllowed ('gamuza/blockchain/transaction');
	}

	public function indexAction ()
	{
	    $this->_title ($this->__('Blockchain'));
	    $this->_title ($this->__('Manage Transactions'));

		$this->loadLayout ();

        $this->_setActiveMenu ('gamuza/blockchain/transaction');
        $this->_addBreadcrumb (Mage::helper ('blockchain')->__("Transaction's Manager"), Mage::helper ('blockchain')->__("Transaction's Manager"));
